                    ...
                    <div
                        ...
                        <div className={"!z-40"}>
                            <div className="relative pt-[56.25%]">
                                <Image
                                    src={anime.cover}
                                    alt={(anime.title.romaji ? anime.title.romaji : anime.title.english)}
                                    height={2160}
                                    width={3840}
                                ...
                                <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
                                    ...
                                    {anime?.trailer &&
                                        <SpeakerButton iconClassName={"h-6 w-6"} buttonClassName={"h-10 w-10"}
                                                       isMuted={isMuted}
                        ...
                        <div className={"flex flex-col space-y-8 px-10 pt-4"}>
                            ...
                            {anime?.recommendations && (
                                <RecommendationCards recommendations={anime?.recommendations}/>)}

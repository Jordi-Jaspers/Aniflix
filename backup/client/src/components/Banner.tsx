                ...
                <>
                    ...
                    <div className={"z-10 h-full space-y-4 flex flex-col justify-end pb-[5%]"}>
                        <div className={"flex flex-col space-y-2 justify-between"}>
                            ...
                            <div
                                className="font-poppins text-[#fefefe] text-justify md:text-[1.2vw] text-shadow-md max-w-xs md:max-w-lg lg:max-w-xl">
                        ...
                        <div className="z-10 flex flex-row justify-between w-full">
                            ...
                            <div className="flex space-x-3">
                                <SpeakerButton iconClassName={"h-4 w-4 md:h-6 md:w-6"}
                                               buttonClassName={"h-8 w-8 md:h-10 md:w-10"}
                                               isMuted={isMuted}

...
import type {ChangeLogFile} from "@interfaces/ChangelogFile";
...
const CHANGELOG_ARCHIVE_PATH = path.join(process.cwd(), 'src', 'components', 'changelog', 'archive');
                ...
                <div className={"h-fit flex flex-row border-t border-b"}>
                    <div className={"w-full flex flex-col"}>
                        {changelogs.map(changelog => {
                            return <ChangelogContent key={changelog.version} version={changelog.version}

...
<div class="flex h-screen w-screen items-center justify-center overflow-hidden">
    <div class="flex-grow-1 absolute left-0 top-[2rem] !z-[10] flex h-[4vw] max-h-12 min-h-6 w-full items-center justify-between px-4 space-x-4">
        <button
    ...
    <div class="flex-grow-1 absolute bottom-[2rem] left-0 !z-[10] flex h-6 w-full space-x-4 items-center justify-between px-4">

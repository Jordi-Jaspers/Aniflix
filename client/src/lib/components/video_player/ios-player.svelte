...
<div class="flex h-screen w-screen items-center justify-center overflow-hidden">
    <div class="flex-grow-1 absolute left-0 top-[2rem] !z-[10] flex h-[4vw] max-h-12 min-h-6 w-full items-center justify-between space-x-4 px-4">
        <button class="relative aspect-square h-full w-auto hover:scale-125"

<script lang="ts">
    ...
    import {AnimeCard, AnimeCarousel} from "$lib/components/browse/index.js";
...
{#if anime}
        ...
        <!--    <AnimeCard url={SERVER_URLS.ANIME_POPULAR_PATH} title="Popular Anime"/>-->
        <!--    <AnimeCarousel url={SERVER_URLS.ANIME_TRENDING_PATH} title="Trending Anime"/>-->
        <!--    <AnimeCarousel url={SERVER_URLS.ANIME_POPULAR_PATH} title="Popular Anime"/>-->
        <!--    <AnimeCarousel url={SERVER_URLS.ANIME_GENRE_PATH} genre={genres[0]} title=" Anime"/>-->
        <!--    <AnimeCarousel url={SERVER_URLS.ANIME_GENRE_PATH} genre={genres[1]} title=" Anime"/>-->
        <!--    <AnimeCarousel url={SERVER_URLS.ANIME_GENRE_PATH} genre={genres[2]} title=" Anime"/>-->
{/if}

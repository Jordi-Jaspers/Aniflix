...
<svelte:head>
	...
	<meta name="description" content="Browse trending anime on Aniflix" />
	<meta name="keywords" content="anime, trending, browse" />
</svelte:head>

<div class="max-w-screen mx-auto min-h-screen max-w-[1096px] overflow-hidden px-[4%]">
	<h1 class="my-4 border-l-2 border-primary px-4 text-3xl font-bold">Trending Anime</h1>
	{#if !isLoading}

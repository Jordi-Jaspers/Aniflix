...
<div class="mx-auto max-screen overflow-hidden max-w-[1096px] px-[4%]">
    <h1 class="my-4 border-l-2 border-primary px-4 text-3xl font-bold">Personal Library</h1>

    <div class="flex flex-col justify-center items-center space-y-2 my-8">
        <div id="search" class="flex justify-between items-center md:w-1/2 h-10 text-sm rounded-md border border-input bg-transparent px-2">
            <input type="text" bind:value={query} placeholder="Search for anime..."
                   class="w-full h-full bg-transparent text-sm focus:outline-none"/>
        ...
        <div id="filters" class="flex justify-center w-full">
            <div id="release-year-filter" class="flex space-x-2 overflow-x-auto scroll-smooth no-scrollbar">

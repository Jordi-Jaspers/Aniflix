...
export default class ConsumetEndpoints {
    ...
    public static ANIME_BY_GENRE: string = `${BASE_URL}/meta/anilist/advanced-search?sort=["SCORE_DESC", "TRENDING_DESC"]&type=ANIME&genres=["{genre}"]&page={page}&perPage={results}`;
